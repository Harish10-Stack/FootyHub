...
import { Heart, Search, Filter, ShoppingCart, Minus, Plus, Trophy, Star, Zap, Award } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 text-gray-900 relative overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-green-600 via-green-700 to-emerald-800 text-white py-14 sm:py-20 mt-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 text-center relative z-10">
          ...
          <p className="text-base sm:text-lg md:text-2xl opacity-95 max-w-4xl mx-auto leading-relaxed font-light px-2">
            ...
            equipment. Elevate your game with professional-grade football gear crafted for champions.
          </p>
          <div className="flex justify-center gap-4 mt-8">
            <Star className="w-6 h-6 text-yellow-300 animate-pulse" />
            <Zap className="w-6 h-6 text-blue-300 animate-pulse" style={{ animationDelay: '0.5s' }} />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-12">
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl p-8 mb-12 border border-white/20 relative overflow-hidden">
          ...
          <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-gradient-to-tr from-blue-200 to-purple-300 rounded-full opacity-15 animate-bounce" style={{ animationDelay: '1s' }}></div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 hover:border-emerald-300/50 transition-all duration-300 overflow-hidden">
                ...
                >
                  ...
                  <option value="Training Equipment">🏋️ Training Equipment</option>
                </select>
          ...
          Object.keys(groupedProducts).map((cat) => (
            <div key={cat} className="mb-20">
              ...
              <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 mb-12 border border-white/30 relative overflow-hidden shadow-xl">
                ...
                <div className="absolute -bottom-4 -right-4 w-16 h-16 bg-gradient-to-tr from-blue-200 to-purple-300 rounded-full opacity-20 animate-bounce" style={{ animationDelay: '0.7s' }}></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-8 h-8 bg-gradient-to-r from-yellow-200 to-orange-300 rounded-full opacity-25 animate-pulse" style={{ animationDelay: '1.2s' }}></div>
                    ...
                    <img
                      ...
                      <div className="p-6 flex flex-col flex-grow relative z-10">
                        <div className="flex-grow">
                          <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mb-2 cursor-pointer hover:text-green-600 transition-colors duration-300 line-clamp-2 min-h-[3rem] group-hover:text-green-700"
          ...
          <div className="text-center py-20">
            ...
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 shadow-xl border border-white/30 max-w-md mx-auto">
              ...
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                We couldn't find any products matching your search. Try adjusting your filters or explore our full collection!
              </p>
              <button
                onClick={() => {
                  setSearch("");
